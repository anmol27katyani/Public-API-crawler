...
class Database:
    def __init__(self):
        ...
        # Either of these will be made
        self.create_connection("localhost", "root", "") # This is used for local testing
        ...
        query3 = "CREATE TABLE newapidb (api VARCHAR(255), description VARCHAR(255) , auth VARCHAR(200), https VARCHAR(200), cors VARCHAR(200), link VARCHAR(200) ,category VARCHAR(290))"
